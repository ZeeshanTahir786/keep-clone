...
const Note = (props) => {
  ...
  const removeLabelFromNote = (label) => {
    ...
    dispatch(editNote(props.note.id, { ...props.note, labels: newLabels }));
  };

  const changeColorHandler = (color) => {
    if (color !== props.note.color) {
      const newNote = { ...props.note, color: color };
      dispatch(editNote(props.note.id, newNote));
    }
    ...
    archiveButton = (
      <Tooltip title="Archive">
        <button
          ...
          onClick={(event) => {
            event.stopPropagation();
            return dispatch(archiveNote(props.note));
          }}
        >
          <ArchiveIcon />
        </button>
    ...
    archiveButton = (
      <Tooltip title="Unarchive">
        <button
          ...
          onClick={(event) => {
            event.stopPropagation();
            return dispatch(unarchiveNote(props.note));
          }}
        >
          <UnarchiveIcon />
        </button>
